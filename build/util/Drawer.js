...
const GreatCircle_1 = require("../blur/GreatCircle");
const ClosedLineConnector_1 = require("../blur/ClosedLineConnector");
const EdgeDetector_1 = require("../blur/EdgeDetector");
class Drawer {
